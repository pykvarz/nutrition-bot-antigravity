...
- REPEAT: повторить предыдущий прием пищи ("повтори обед", "то же самое", "съел то же что и вчера вечером")
  В details укажи target_date_offset (-1 для вчера), time_of_day (morning/afternoon/evening), query_label
...
- SETTINGS: изменение настроек или целей ("поставь цель 1800 калорий", "теперь белок 140", "какие у меня цели?")
  Если есть новые значения, добавь их в details.settings_update, например:
  {"settings_update": {"TARGET_CALORIES": 1800.0, "TARGET_PROTEIN": 140.0}}
